...
const VideoAnalysis = () => {
  ...
  const handleAnalysis = async () => {
    ...
    try {
      const analysisResults = await aiService.analyzeVideo(videoFile);
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Detecta contenido generado por IA en videos usando análisis avanzado
          </p>
        </div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    >
                      {results.verdict === "AI-Generated"
                        ? "Este video probablemente fue generado por IA"
                        : "Este video probablemente fue creado por un humano"}
                    </p>
                  </div>
                </div>
              </div>
