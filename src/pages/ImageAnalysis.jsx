...
const ImageAnalysis = () => {
  ...
  const handleAnalysis = async () => {
    ...
    try {
      const analysisResults = await aiService.analyzeImage(imageFile);
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Detecta contenido generado por IA en imágenes usando análisis
            avanzado
          </p>
        </div>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    >
                      {results.verdict === "AI-Generated"
                        ? "Esta imagen probablemente fue generada por IA"
